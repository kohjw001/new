# 제목 1
[README](README.dCXL8RG4M9DWzIcinj)
<br>
[my github](http://guides.github.com/features/mastering-markdown)
sd
aasdfaasg<br>
kjonkmokn<br>
oknoknonok<br>
...
문장에서 **강조**, _이탈릭_
글에서 글자 색상을 주려면 <span style='color:red;'>HTML tag</span>를 이용한다.
...
문자를 출력하는 'printf("%s","test")'은 시스템 출력으로
